...
- F5. `GtmAgentGetConfigState` (line ~101) also enumerates `industry-%` sections itself. Whether it filters Draft is UNVERIFIED and out of scope; the Developer reads it and reports, does not change it.
