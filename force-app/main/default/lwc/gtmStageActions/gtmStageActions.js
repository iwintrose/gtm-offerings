...
import { openAssessment } from 'c/gtmNavigate';
...
export default class GtmStageActions extends NavigationMixin(LightningElement) {
    @api configId      = '';
    ...
    /** "View assessment" opens the assessment workspace, not the AR record page. */
    handleViewAssessment() {
        openAssessment(this, this._ctx?.assessmentId);
    }
